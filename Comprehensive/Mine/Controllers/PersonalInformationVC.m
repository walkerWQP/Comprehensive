...
@interface PersonalInformationVC ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    //添加背景view
    CGRect backView_frame = CGRectMake(0, -kStatusBarHeight, ScreenWidth, kNavigationBarHeight+kStatusBarHeight);
    ...
    //header
    CGRect bounds = CGRectMake(0, 0, ScreenWidth, self.headerHeight);
...
-(void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (offset_Y < -64) {
        ...
        //改变 frame
        CGRect contentView_frame = CGRectMake(0, -add_topHeight, ScreenWidth, self.headerHeight+add_topHeight);
        self.headerContentView.frame = contentView_frame;
        CGRect imageView_frame = CGRectMake(-(ScreenWidth*self.scale-ScreenWidth)/2.0f,0,ScreenWidth*self.scale,self.headerHeight+add_topHeight);
        self.headerImageView.frame = imageView_frame;
        
        CGRect icon_frame = CGRectMake(12, self.headerContentView.bounds.size.height-80-12, 80, 80);
        self.icon.frame = icon_frame;
        
        self.label.frame = CGRectMake(108, self.headerContentView.bounds.size.height-60-12, ScreenWidth-108-12, 50);
...
-(UITableView *)tableView{
    if (_tableView == nil) {
        ...
        CGRect tableView_frame = CGRectMake(0, -64, ScreenWidth, ScreenHeight+kNavigationBarHeight+kStatusBarHeight);
